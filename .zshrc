...
alias dotfiles='/usr/bin/git --git-dir=$HOME/Projects/aw-dotfiles/ --work-tree=$HOME' 
alias startpage='nvim $HOME/.mozilla/firefox/nniee2w1.default-release/chrome/startpage/index.html'
alias ohmyzsh='nvim ~/.oh-my-zsh/oh-my-zsh.sh'
alias searxconfig='nvim /etc/searx/settings.yml'
